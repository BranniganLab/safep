...
def plot_samples(theax, u_nk, color='blue', label='Raw Data'):
    """
    Plot the number of samples against the wavelength.

    Parameters:
        theax (matplotlib.axes.Axes): The axes object to plot the samples on.
        u_nk (numpy.ndarray): The input data array.
        color (str, optional): The color of the plot. Defaults to 'blue'.
        label (str, optional): The label for the plot. Defaults to 'Raw Data'.
